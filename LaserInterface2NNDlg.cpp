...
// LaserInterface2NNDlg.cpp : implementation file
//

#include "pch.h"
#include "framework.h"
#include "LaserInterface2NN.h"
#include "LaserInterface2NNDlg.h"
...
CLaserInterface2NNDlg::CLaserInterface2NNDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_LASERINTERFACE2NN_DIALOG, pParent)
...
CLaserInterface2NNDlg::~CLaserInterface2NNDlg()
{
...
BEGIN_MESSAGE_MAP(CLaserInterface2NNDlg, CDialogEx)
	...
	ON_EN_KILLFOCUS(IDC_EDIT_PRF, &CLaserInterface2NNDlg::OnEnKillfocusEditPrf)
	ON_EN_KILLFOCUS(IDC_EDIT_ACTIVE, &CLaserInterface2NNDlg::OnEnKillfocusEditActive)
	ON_EN_KILLFOCUS(IDC_EDIT_SIMMER, &CLaserInterface2NNDlg::OnEnKillfocusEditSimmer)
	ON_EN_KILLFOCUS(IDC_EDIT_DUTY_FACTOR, &CLaserInterface2NNDlg::OnEnKillfocusEditDutyFactor)
	ON_EN_KILLFOCUS(IDC_EDIT_BURST_LENGTH, &CLaserInterface2NNDlg::OnEnKillfocusEditBurstLength)
	ON_BN_CLICKED(IDC_BUTTON_STANDBY, &CLaserInterface2NNDlg::OnBnClickedButtonStandby)
	ON_BN_CLICKED(IDC_BUTTON_ENABLE, &CLaserInterface2NNDlg::OnBnClickedButtonEnable)
	ON_BN_CLICKED(IDC_BUTTON_TRIGGER, &CLaserInterface2NNDlg::OnBnClickedButtonTrigger)
	ON_BN_CLICKED(IDC_BUTTON_RAL_ON, &CLaserInterface2NNDlg::OnBnClickedButtonRalOn)
	ON_WM_TIMER()
	ON_WM_CLOSE()
	ON_WM_CTLCOLOR()
END_MESSAGE_MAP()
...
// CLaserInterface2NNDlg message handlers

BOOL CLaserInterface2NNDlg::OnInitDialog()
{
	...
	m_cAKGHWCDummy6Axis.m_cLaserInterface2NNDlg = this;
...
void CLaserInterface2NNDlg::OnPaint()
{
	if (IsIconic())
	{
...
HCURSOR CLaserInterface2NNDlg::OnQueryDragIcon()
{
...
void CLaserInterface2NNDlg::setTooltipForControl()
{
...
void CLaserInterface2NNDlg::connectAsTCPIPClient(CString csIpAdress, int iPortNum)
{
...
void CLaserInterface2NNDlg::disconnectFromTCPIPClient()
{
...
//UINT32 CLaserInterface2NNDlg::getBaudRate()
//{
//	// Prepare command
...
bool CLaserInterface2NNDlg::setBaudRate(UINT32 baudRate)
{
...
void CLaserInterface2NNDlg::HandleBaudRateResponse(BYTE response)
{
	switch (response)
	{
	case 0x00:
...
void CLaserInterface2NNDlg::HandleLaserInterfaceControlModeResponse(BYTE response)
{
	switch (response)
	{
	case 0x00:
...
void CLaserInterface2NNDlg::HandleLaserControlSignalsResponse(BYTE response)
{
	switch (response)
	{
	case 0x00:
...
void CLaserInterface2NNDlg::HandleAnalogCurrentSetPointResponse(BYTE response)
{
	switch (response)
	{
	case 0x00:
...
void CLaserInterface2NNDlg::HandlePulseWaveformResponse(BYTE response)
{
	switch (response)
	{
	case 0x00:
...
void CLaserInterface2NNDlg::HandlePulseRateResponse(BYTE response)
{
	switch (response)
	{
	case 0x00:
...
void CLaserInterface2NNDlg::HandlePulseBurstLengthResponse(BYTE response)
{
	switch (response)
	{
	case 0x00:
...
void CLaserInterface2NNDlg::HandlePumpDutyFactorResponse(BYTE response)
{
	switch (response)
	{
	case 0x00:
...
bool CLaserInterface2NNDlg::WaitForData(int timeoutMilliseconds)
{
...
void CLaserInterface2NNDlg::DoEvent(int iDelay)
{
	MSG msg;
...
void CLaserInterface2NNDlg::setReceivedDataFromTheAPS(COMMAND iCommandType, UINT iVal)
{
...
void CLaserInterface2NNDlg::setReceivedDataFromTheLaserStatus(COMMAND iCommandType, double dVal)
{
	// Map COMMAND values to their corresponding control IDs
	std::map<COMMAND, int> commandToControlID = {
...
BOOL CLaserInterface2NNDlg::getCheckSumValidation()
{
...
FirmwareDetails CLaserInterface2NNDlg::getLaserFirmwareDetails()
{
	// Prepare command
...
LaserDescription CLaserInterface2NNDlg::getLaserDescription()
{
	// Prepare command
...
void CLaserInterface2NNDlg::OnDeltaposSpinPrf(NMHDR* pNMHDR, LRESULT* pResult)
{
...
void CLaserInterface2NNDlg::OnDeltaposSpinActive(NMHDR* pNMHDR, LRESULT* pResult)
{
	LPNMUPDOWN pNMUpDown = reinterpret_cast<LPNMUPDOWN>(pNMHDR);
...
void CLaserInterface2NNDlg::OnDeltaposSpinSimmer(NMHDR* pNMHDR, LRESULT* pResult)
{
	LPNMUPDOWN pNMUpDown = reinterpret_cast<LPNMUPDOWN>(pNMHDR);
...
void CLaserInterface2NNDlg::OnDeltaposSpinDutyFactor(NMHDR* pNMHDR, LRESULT* pResult)
{
	LPNMUPDOWN pNMUpDown = reinterpret_cast<LPNMUPDOWN>(pNMHDR);
...
void CLaserInterface2NNDlg::OnDeltaposSpinBurstLength(NMHDR* pNMHDR, LRESULT* pResult)
{
	LPNMUPDOWN pNMUpDown = reinterpret_cast<LPNMUPDOWN>(pNMHDR);
...
void CLaserInterface2NNDlg::OnCbnSelchangeComboWaveform()
{
...
void CLaserInterface2NNDlg::OnEnKillfocusEditPrf()
{
	UpdateData();
...
void CLaserInterface2NNDlg::OnEnKillfocusEditActive()
{
	UpdateData();
...
void CLaserInterface2NNDlg::OnEnKillfocusEditSimmer()
{
	UpdateData();
...
void CLaserInterface2NNDlg::OnEnKillfocusEditBurstLength()
{
	UpdateData();
...
void CLaserInterface2NNDlg::OnTimer(UINT_PTR nIDEvent)
{
	if (nIDEvent == 1)
	{
		KillTimer(m_nTimerID);
...
void CLaserInterface2NNDlg::OnOK()
{
	// TODO: Add your specialized code here and/or call the base class
...
void CLaserInterface2NNDlg::setLEDLaserOn(bool val)
{
	setLED(m_ctrlLaserOn, val, m_bmpYellow, m_bmpGrey);
}

void CLaserInterface2NNDlg::setLEDLaserEnabled(bool val)
{
	setLED(m_ctrlLaserEnabled, val, m_bmpYellow, m_bmpGrey);
}

void CLaserInterface2NNDlg::setLEDLaserDisabled(bool val)
{
	setLED(m_ctrlLaserDisabled, val, m_bmpYellow, m_bmpGrey);
}

void CLaserInterface2NNDlg::setLEDLaserEmissionGate(bool val)
{
	setLED(m_ctrlLaserEmissionGate, val, m_bmpYellow, m_bmpGrey);
}

void CLaserInterface2NNDlg::setLEDLaserEmission(bool val)
{
	setLED(m_ctrlLaserEmission, val, m_bmpYellow, m_bmpGrey);
}

void CLaserInterface2NNDlg::setLEDMonitor(bool val)
{
	setLED(m_ctrlMonitor, val, m_bmpYellow, m_bmpGrey);
}

void CLaserInterface2NNDlg::setLEDCW(bool val)
{
	setLED(m_ctrlCW, val, m_bmpYellow, m_bmpGrey);
}

void CLaserInterface2NNDlg::setLEDAlarm(bool val)
{
	setLED(m_ctrlAlarm, val, m_bmpYellow, m_bmpGrey);
}

void CLaserInterface2NNDlg::setLEDSystemFault(bool val)
{
	setLED(m_ctrlSystemFault, val, m_bmpYellow, m_bmpGrey);
}

void CLaserInterface2NNDlg::setLEDTaskActive(bool val)
{
	setLED(m_ctrlTaskActive, val, m_bmpYellow, m_bmpGrey);
}

void CLaserInterface2NNDlg::setLEDLaserBodyTemp(bool val)
{
	setLED(m_ctrlLaserBodyTemp, val, m_bmpYellow, m_bmpGrey);
}

void CLaserInterface2NNDlg::setLEDBeamDeliveryTemp(bool val)
{
	setLED(m_ctrlBeamDeliveryTemp, val, m_bmpYellow, m_bmpGrey);
}

void CLaserInterface2NNDlg::setLEDPowerSupplyFault(bool val)
{
	setLED(m_ctrlPowerSupplyFault, val, m_bmpRed, m_bmpGrey);
}

void CLaserInterface2NNDlg::setLEDFanFault(bool val)
{
	setLED(m_ctrlFanFault, val, m_bmpRed, m_bmpGrey);
}

void CLaserInterface2NNDlg::setLEDEmergencyStopFault(bool val)
{
	setLED(m_ctrlEmergencyStopFault, val, m_bmpRed, m_bmpGrey);
}

void CLaserInterface2NNDlg::setLED(CStatic& ctrlLED, bool val, HBITMAP hBitmapOn, HBITMAP hBitmapOff)
{
	HBITMAP hBitmap = val ? hBitmapOn : hBitmapOff;
	ctrlLED.SetBitmap(hBitmap);
}

HBRUSH CLaserInterface2NNDlg::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
